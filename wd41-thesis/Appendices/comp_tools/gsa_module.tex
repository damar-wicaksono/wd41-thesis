...
The module was developed and tested using the \href{https://www.anaconda.com/distribution/}{Anaconda Python} distribution of Python \texttt{v3.5}. No additional package except the base installation of the distribution is required.

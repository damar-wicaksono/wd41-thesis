...
%-----------------------------------------------------------------------------------------------------
\subsection{FEBA Test No. 216, Cladding Temperature Output (TC)}\label{app:tbl_results_uq_post_tc_216}
%-----------------------------------------------------------------------------------------------------
...
\rotatebox{90}{\begin{minipage}{0.85\textheight}
    \includegraphics[width=0.95\textwidth]{../figures/chapter5/figures/plotTraceUQPosteriorAllDiscCenteredTC223}
		\captionof{figure}[Posterior uncertainty propagation of FEBA Test No. $223$ for the cladding temperature output ($TC$). The posterior samples are from the calibration scheme \texttt{w/ Bias, All}.]{Uncertainty propagation of the parameters uncertainty of \gls[hyper=false]{feba} Test No. $223$ for the cladding temperature output ($TC$) at different axial locations. The uncertainty bands refer to the symmetric $95\%$ probabilities. Solid lines, dashed lines, and crosses indicate the simulation with the nominal parameters values, the median of the posterior, and the experimental data, respectively. The posterior samples are from the calibration with model bias term and considering all types of output (\texttt{w/ Bias, All}).}
...
\rotatebox{90}{\begin{minipage}{0.85\textheight}
    \includegraphics[width=0.95\textwidth]{../figures/chapter5/figures/plotTraceUQPosteriorAllDiscCenteredTC220}
		\captionof{figure}[Posterior uncertainty propagation of FEBA Test No. $220$ for the cladding temperature output ($TC$). The posterior samples are from the calibration scheme \texttt{w/ Bias, All}.]{Uncertainty propagation of the parameters uncertainty of \gls[hyper=false]{feba} Test No. $220$ for the cladding temperature output ($TC$) at different axial locations. The uncertainty bands refer to the symmetric $95\%$ probabilities. Solid lines, dashed lines, and crosses indicate the simulation with the nominal parameters values, the median of the posterior, and the experimental data, respectively. The posterior samples are from the calibration with model bias term and considering all types of output (\texttt{w/ Bias, All}).}
...
\rotatebox{90}{\begin{minipage}{0.85\textheight}
    \includegraphics[width=0.95\textwidth]{../figures/chapter5/figures/plotTraceUQPosteriorAllDiscCenteredTC222}
		\captionof{figure}[Posterior uncertainty propagation of FEBA Test No. $222$ for the cladding temperature output ($TC$). The posterior samples are from the calibration scheme \texttt{w/ Bias, All}.]{Uncertainty propagation of the parameters uncertainty of \gls[hyper=false]{feba} Test No. $222$ for the cladding temperature output ($TC$) at different axial locations. The uncertainty bands refer to the symmetric $95\%$ probabilities. Solid lines, dashed lines, and crosses indicate the simulation with the nominal parameters values, the median of the posterior, and the experimental data, respectively. The posterior samples are from the calibration with model bias term and considering all types of output (\texttt{w/ Bias, All}).}
...
\bigfigure[pos=tbhp,
           ...
           shortcaption={Posterior uncertainty propagation of FEBA Test No. $216$ for the pressure drop output ($DP$). The posterior samples are from the calibration scheme \texttt{w/ Bias, no dffbVIHT}.}]
...
\bigfigure[pos=h!,
           ...
           shortcaption={Posterior uncertainty propagation of FEBA Test No. $216$ for the pressure drop output ($DP$). The posterior samples are from the calibration scheme \texttt{w/o Bias}.}]
...
\bigfigure[pos=tbhp,
           ...
           shortcaption={Posterior uncertainty propagation of FEBA Test No. $214$ for the pressure drop output ($DP$). The posterior samples are from the calibration scheme \texttt{w/ Bias, All}.}]
{../figures/chapter5/figures/plotTraceUQPosteriorAllDiscCenteredDP214}
{Uncertainty propagation of the parameters uncertainty of \gls[hyper=false]{feba} Test No. $214$ for the pressure drop output ($DP$) at different axial segments. The uncertainty bands refer to the symmetric $95\%$ probabilities. Solid lines, dashed lines, and crosses indicate the simulation with the nominal parameters values, the median of the posterior, and the experimental data, respectively. The posterior samples are from the calibration with model bias term and considering all types of output (\texttt{w/ Bias, All}).}
...
\bigfigure[pos=tbhp,
           ...
           shortcaption={Posterior uncertainty propagation of FEBA Test No. $214$ for the pressure drop output ($DP$). The posterior samples are from the calibration scheme \texttt{w/ Bias, no dffbVIHT}.}]
...
\bigfigure[pos=h!,
           ...
           shortcaption={Posterior uncertainty propagation of FEBA Test No. $214$ for the pressure drop output ($DP$). The posterior samples are from the calibration scheme \texttt{w/o Bias}.}]
...
\bigfigure[pos=tbhp,
           ...
           shortcaption={Posterior uncertainty propagation of FEBA Test No. $223$ for the pressure drop output ($DP$). The posterior samples are from the calibration scheme \texttt{w/ Bias, All}.}]
{../figures/chapter5/figures/plotTraceUQPosteriorAllDiscCenteredDP223}
{Uncertainty propagation of the parameters uncertainty of \gls[hyper=false]{feba} Test No. $223$ for the pressure drop output ($DP$) at different axial segments. The uncertainty bands refer to the symmetric $95\%$ probabilities. Solid lines, dashed lines, and crosses indicate the simulation with the nominal parameters values, the median of the posterior, and the experimental data, respectively. The posterior samples are from the calibration with model bias term and considering all types of output (\texttt{w/ Bias, All}).}
...
\bigfigure[pos=tbhp,
           ...
           shortcaption={Posterior uncertainty propagation of FEBA Test No. $223$ for the pressure drop output ($DP$). The posterior samples are from the calibration scheme \texttt{w/ Bias, no dffbVIHT}.}]
...
\bigfigure[pos=h!,
           ...
           shortcaption={Posterior uncertainty propagation of FEBA Test No. $223$ for the pressure drop output ($DP$). The posterior samples are from the calibration scheme \texttt{w/o Bias}.}]
...
\bigfigure[pos=tbhp,
           ...
           shortcaption={Posterior uncertainty propagation of FEBA Test No. $218$ for the pressure drop output ($DP$). The posterior samples are from the calibration scheme \texttt{w/ Bias, All}.}]
{../figures/chapter5/figures/plotTraceUQPosteriorAllDiscCenteredDP218}
{Uncertainty propagation of the parameters uncertainty of \gls[hyper=false]{feba} Test No. $218$ for the pressure drop output ($DP$) at different axial segments. The uncertainty bands refer to the symmetric $95\%$ probabilities. Solid lines, dashed lines, and crosses indicate the simulation with the nominal parameters values, the median of the posterior, and the experimental data, respectively. The posterior samples are from the calibration with model bias term and considering all types of output (\texttt{w/ Bias, All}).}
...
\bigfigure[pos=tbhp,
           ...
           shortcaption={Posterior uncertainty propagation of FEBA Test No. $218$ for the pressure drop output ($DP$). The posterior samples are from the calibration scheme \texttt{w/ Bias, no dffbVIHT}.}]
...
\bigfigure[pos=h!,
           ...
           shortcaption={Posterior uncertainty propagation of FEBA Test No. $218$ for the pressure drop output ($DP$). The posterior samples are from the calibration scheme \texttt{w/o Bias}.}]
...
\bigfigure[pos=tbhp,
           ...
           shortcaption={Posterior uncertainty propagation of FEBA Test No. $220$ for the pressure drop output ($DP$). The posterior samples are from the calibration scheme \texttt{w/ Bias, All}.}]
...
\bigfigure[pos=h!,
           ...
           shortcaption={Posterior uncertainty propagation of FEBA Test No. $220$ for the pressure drop output ($DP$). The posterior samples are from the calibration scheme \texttt{w/o Bias}.}]
...
\bigfigure[pos=tbhp,
           ...
           shortcaption={Posterior uncertainty propagation of FEBA Test No. $222$ for the pressure drop output ($DP$). The posterior samples are from the calibration scheme \texttt{w/ Bias, All}.}]
{../figures/chapter5/figures/plotTraceUQPosteriorAllDiscCenteredDP222}
{Uncertainty propagation of the parameters uncertainty of \gls[hyper=false]{feba} Test No. $222$ for the pressure drop output ($DP$) at different axial segments. The uncertainty bands refer to the symmetric $95\%$ probabilities. Solid lines, dashed lines, and crosses indicate the simulation with the nominal parameters values, the median of the posterior, and the experimental data, respectively. The posterior samples are from the calibration with model bias term and considering all types of output (\texttt{w/ Bias, All}).}
...
\bigfigure[pos=tbhp,
           ...
           shortcaption={Posterior uncertainty propagation of FEBA Test No. $222$ for the pressure drop output ($DP$). The posterior samples are from the calibration scheme \texttt{w/ Bias, no dffbVIHT}.}]
...
\bigfigure[pos=h!,
           ...
           shortcaption={Posterior uncertainty propagation of FEBA Test No. $222$ for the pressure drop output ($DP$). The posterior samples are from the calibration scheme \texttt{w/o Bias}.}]
...
\bigtriplefigure[pos=tbhp,
                 mainlabel={fig:ch5_plot_trace_uq_post_co_216},
			           maincaption={Posterior uncertainty propagation of \gls[hyper=false]{feba} Test No. $216$ for the liquid carryover outputs ($CO$) from three different calibration schemes. The uncertainty bands refer to the symmetric $95\%$ probabilities. Solid lines, dashed lines, and crosses indicate the simulation with the nominal parameters values, the median of the posterior, and the experimental data, respectively.},
			           mainshortcaption={Posterior uncertainty propagation of FEBA Test No. $216$ for the liquid carryover outputs ($CO$) from three different calibration schemes.},%
...
\bigtriplefigure[pos=tbhp,
                 mainlabel={fig:ch5_plot_trace_uq_post_co_214},
			           maincaption={Posterior uncertainty propagation of \gls[hyper=false]{feba} Test No. $214$ for the liquid carryover outputs ($CO$) from three different calibration schemes. The uncertainty bands refer to the symmetric $95\%$ probabilities. Solid lines, dashed lines, and crosses indicate the simulation with the nominal parameters values, the median of the posterior, and the experimental data, respectively.},
			           mainshortcaption={Posterior uncertainty propagation of FEBA Test No. $214$ for the liquid carryover outputs ($CO$) from three different calibration schemes.},%
			           leftopt={width=0.31\textwidth},
...
\bigtriplefigure[pos=tbhp,
                 mainlabel={fig:ch5_plot_trace_uq_post_co_223},
			           maincaption={Posterior uncertainty propagation of \gls[hyper=false]{feba} Test No. $223$ for the liquid carryover outputs ($CO$) from three different calibration schemes. The uncertainty bands refer to the symmetric $95\%$ probabilities. Solid lines, dashed lines, and crosses indicate the simulation with the nominal parameters values, the median of the posterior, and the experimental data, respectively.},
			           mainshortcaption={Posterior uncertainty propagation of FEBA Test No. $223$ for the liquid carryover outputs ($CO$) from three different calibration schemes.},%
			           leftopt={width=0.31\textwidth},
...
\bigtriplefigure[pos=tbhp,
                 mainlabel={fig:ch5_plot_trace_uq_post_co_218},
			           maincaption={Posterior uncertainty propagation of \gls[hyper=false]{feba} Test No. $218$ for the liquid carryover outputs ($CO$) from three different calibration schemes. The uncertainty bands refer to the symmetric $95\%$ probabilities. Solid lines, dashed lines, and crosses indicate the simulation with the nominal parameters values, the median of the posterior, and the experimental data, respectively.},
			           mainshortcaption={Posterior uncertainty propagation of FEBA Test No. $218$ for the liquid carryover outputs ($CO$) from three different calibration schemes.},%
			           leftopt={width=0.31\textwidth},
...
\bigtriplefigure[pos=tbhp,
                 mainlabel={fig:ch5_plot_trace_uq_post_co_220},
			           maincaption={Posterior uncertainty propagation of \gls[hyper=false]{feba} Test No. $220$ for the liquid carryover outputs ($CO$) from three different calibration schemes. The uncertainty bands refer to the symmetric $95\%$ probabilities. Solid lines, dashed lines, and crosses indicate the simulation with the nominal parameters values, the median of the posterior, and the experimental data, respectively.},
			           mainshortcaption={Posterior uncertainty propagation of FEBA Test No. $220$ for the liquid carryover outputs ($CO$) from three different calibration schemes.},%
			           leftopt={width=0.31\textwidth},
...
\bigtriplefigure[pos=tbhp,
                 mainlabel={fig:ch5_plot_trace_uq_post_co_222},
			           maincaption={Posterior uncertainty propagation of \gls[hyper=false]{feba} Test No. $222$ for the liquid carryover outputs ($CO$) from three different calibration schemes. The uncertainty bands refer to the symmetric $95\%$ probabilities. Solid lines, dashed lines, and crosses indicate the simulation with the nominal parameters values, the median of the posterior, and the experimental data, respectively.},
			           mainshortcaption={Posterior uncertainty propagation of FEBA Test No. $222$ for the liquid carryover outputs ($CO$) from three different calibration schemes.},%
			           leftopt={width=0.31\textwidth},

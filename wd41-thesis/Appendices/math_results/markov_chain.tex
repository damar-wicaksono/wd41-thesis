...
Many of the concepts are introduced first, and some are exclusively, for the discrete-state Markov chain.
...
though many important equivalent theorems are difficult to even state without the prerequisite notions involving measure theory.

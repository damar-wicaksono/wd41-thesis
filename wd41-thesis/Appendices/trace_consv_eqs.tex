...
In the subsequent section the angle brackets and the overbar will be dropped from the void fraction notation Eq.~(\ref{eq:void_fraction}) and any mention of void fraction will refer to the above time- and volume-averaged formulation.

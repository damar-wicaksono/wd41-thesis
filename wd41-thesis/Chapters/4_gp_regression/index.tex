...
Section~\ref{sec:gp_constructing_metamodel} and Section~\ref{sec:gp_dimension_reduction} deal with practical aspects of constructing a metamodel based on Gaussian process.
The first includes brief explanations on the choice design of experiments used to generate data (i.e., code runs), the metamodel fitting, and the metamodel validation, 
while the latter deals specifically with an approach to tackle the case of codes with multiple outputs.

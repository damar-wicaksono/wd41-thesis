...
The latter is mostly due to the fact that the clad temperature output include a sharp discontinuity (i.e., quenching).
...
Again, no further study was conducted to have a quantitative cost measure.

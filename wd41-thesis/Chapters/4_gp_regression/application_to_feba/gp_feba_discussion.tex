...
The size of validation/testing data set can be constrained by first making a plot similar to the one in Fig.~\ref{fig:ch4_plot_q2_pcs} but with smaller number of samples to first check the convergence of the error estimate before creating unnecessarily large set upfront.
...
That is, for a given experimental design algorithm of a given size, $5$ different metamodels were trained.
...
%\footnote{Though in principle it was possible to combine all different outputs into a single metamodel through the correlation formulation of the \gls[hyper=false]{pca},
%this combination was avoided to allow for important parameters with respect to each outputs retained its prominence.
...
% Testing
Finally, the ultimate performance of the metamodel constructed with best selected setting were assessed in the testing step based on yet another large number of test dataset, separately generated.
\marginpar{testing}
...
\begin{table}[!htpb]
    ...
    \begin{tabularx}{\textwidth}{Xl} \toprule
        ...
        \footnotesize{Sample sizes}  	        & \footnotesize{$120, 240, 480, 960$}\\

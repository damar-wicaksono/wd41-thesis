...
A \gls[hyper=false]{gp} $\mathcal{Y}(\bm{x})$ on $\mathbf{X} \subseteq \mathbb{R}^D$ with a given mean function $m$ and covariance $K$ is denoted as
\begin{equation}
...
% Mean Function
The mean function of a Gaussian process $\mathcal{Y}(\bm{x})$ is the function $m: \mathbf{X} \subseteq \mathbb{R}^D \mapsto \mathbb{R}$ defined as,
...
% Covariance Function
The covariance function of a Gaussian process $\mathcal{Y}(\bm{x})$, on the other hand, is the function $K: (\mathbf{X} \subseteq \mathbb{R}^D) \times (\mathbf{X} \subseteq \mathbb{R}^D) \mapsto \mathbb{R}$ defined as,
...
$\cdots, \bm{x}_L\} \in \mathbf{X} \subseteq \mathbb{R}^D$ with $L \geq 1$, 
...
\end{equation}
where $R$, the correlation kernel function, is defined such that $\bm{x}_i, \bm{x}_j \in \bm{X} \subseteq \mathbb{R}^D \, \forall \, i, j $;

...
\normdoublefigure[pos=tbhp,
                  ...
                  %leftshortcaption={},%
                  rightopt={width=0.45\textwidth},%width=0.45\textwidth},
                  rightlabel={fig:plot_corrfun_matern},
                  rightcaption={},
                  %rightshortcaption={},
                  %spacing={\hfill}
                 ]
...
The use of mean function provides an opportunity to incorporate prior knowledge of the process before observing any data or to improve the resulting model performance for extrapolation purpose (citation).
...
Instead, the zero-mean stationary Gaussian process is the most widely used in the applied literature (citation).
Indeed, it was argued in (citation) that the use of either zero or constant mean in GP to model a process signifies a vague or the least informative prior to the unknown.

...
As mentioned in the opening of this chapter, reflood phase is the last phase of the $4$ canonical phases in the mitigation of \gls[hyper=false]{lbloca} in \glspl[hyper=false]{lwr},
...
The flow regime itself represents an interpolatory region between the previous \glsshortentry{dffb} flow regime and the subsequent \gls[hyper=false]{iafb} flow regime \cite{USNRC2012}.

...
Keeping the power constant increases the cladding temperature up until more mixture of steam and liquid (droplets) arrives at the location, improve the \gls[hyper=false]{ht} mechanism, and turn the temperature around from the maximum ($T_\text{max.}$).

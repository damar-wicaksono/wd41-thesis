...
following whenever possible the modeling best-practices guidelines for the \gls[hyper=false]{trace} code \cite{USNRC2012a} to minimize user effect.
...
As a result, each of the coarse conduction nodes was divided uniformly in $5$, yielding a total of $142$ axial conduction nodes.

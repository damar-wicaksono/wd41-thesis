...
Appendix~\ref{app:trace_consv_eqs} summarize the final formulation of governing equations (time\- and volume-averaged) in \gls[hyper=false]{trace}, of which the complete derivation can be found in \cite{USNRC2012}.

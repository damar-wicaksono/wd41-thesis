...
Additionally, the interfacial structure and its deformation in an arbitrary flow configuration are not known \emph{a priori} and becomes part of the solution.

...
to improve the knowledge of \gls[hyper=false]{ht} mechanism during reflooding,
...
These included thermocouples to measure the clad temperature (referred to as $TC$) at $8$ different axial locations,
pressure probes to measure the pressure drop (referred to as $DP$) at $4$ different axial segments of the test assembly,

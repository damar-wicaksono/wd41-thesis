...
This particular \gls[hyper=false]{fpc} corresponds to a mode of variation that relates to the amplitude of the temperature reversal period (see Chapter~\ref{ch:trace_reflood}).
...
\normdoublefigure[pos=tbhp,
                  ...
                  leftopt={width=0.43\textwidth},%width=0.45\textwidth},
                  leftlabel={fig:ch3_plot_pc1_co_fpc},
                  leftcaption={1\textsuperscript{st} fPC (93\% Output variation)},
                  %leftshortcaption={},%
                  rightopt={width=0.43\textwidth},%width=0.45\textwidth},

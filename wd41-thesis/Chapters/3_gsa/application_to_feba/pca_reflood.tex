...
To derive a more innovative set of \glspl[hyper=false]{qoi},
...
it can parsimoniously describe the overall variation of the time-dependent curve in a smaller set of numbers.
...
The first \gls[hyper=false]{fpc} of the (registered) clad temperature at at the mid-height of the assembly in the reflood transient and the effect of its perturbation around the mean function are shown in Fig.~\ref{fig:ch3_plot_pc1_tc4}.
...
this multiplication was done to give it a sense of scale with respect to the cladding temperature variation.
...
This particular \gls[hyper=false]{fpc} corresponds to a mode of variation that relates to the amplitude of the temperature reversal period.
...
It is also interesting to see the phase variations in the dataset separately.
...
\normdoublefigure[pos=tbhp,
                  ...
                  maincaption={The 1\textsuperscript{st} \gls[hyper=false]{fpc} of the pressure drop transient at the mid. of the assembly and the effect of its perturbation on the mean function.},%
									mainshortcaption={The 1\textsuperscript{st} \gls[hyper=false]{fpc} of the pressure drop transient at the mid. of the assembly and the effect of its perturbation on the mean function.},
                  leftopt={width=0.45\textwidth},%width=0.45\textwidth},

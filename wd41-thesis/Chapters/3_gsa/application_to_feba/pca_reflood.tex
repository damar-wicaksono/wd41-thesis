...
\bigtriplefigure[pos=tbhp,
			           ...
			           leftcaption={Mid-height clad temperature},
...
\marginpar{1\textsuperscript{st} \gls[hyper=false]{fpc} of the (registered) mid-height clad temperature transient}
...
this multiplication was done to give it a sense of scale with respect to the clad temperature variation (as $\sqrt{\rho_j}$ represents the standard deviation of the mode $j$).
...
\normdoublefigure[pos=tbhp,
                  ...
                  maincaption={The 1\textsuperscript{st} \gls[hyper=false]{fpc} of the (registered) mid-height clad temperature transient and the effect of its perturbation on the mean function.},%
									mainshortcaption={The 1\textsuperscript{st} \gls[hyper=false]{fpc} of the (registered) mid-height clad temperature transient and the effect of its perturbation on the mean function.},
...
Fig.~\ref{fig:ch3_plot_pc2_tc4} shows the results for the second \gls[hyper=false]{fpc} of the (registered) mid-height clad temperature transient and the effect of its perturbation on the mean function.
\marginpar{2\textsuperscript{nd} \gls[hyper=false]{fpc} of the (registered) mid-height clad temperature transient}
...
\normdoublefigure[pos=tbhp,
                  ...
                  maincaption={The 2\textsuperscript{nd} \gls[hyper=false]{fpc} of the (registered) mid-height clad temperature transient and the effect of its perturbation on the mean function.},%
									mainshortcaption={The 2\textsuperscript{nd} \gls[hyper=false]{fpc} of the (registered) mid-height clad temperature transient and the effect of its perturbation on the mean function.},
                  leftopt={width=0.40\textwidth},
...
\marginpar{1\textsuperscript{st} \gls[hyper=false]{fpc} of the warping function for the mid-height clad temperature transient}
clad temperature transient where the phase variations in the data set have been removed.

...
\begin{sidewaysfigure}
	...
	\caption[Flowchart for the implemented sensitivity analysis methodology applied to the TRACE model of the FEBA facility]{The flowchart for the implemented sensitivity analysis methodology applied to the \gls[hyper=false]{trace} model of \gls[hyper=false]{feba} facility.}

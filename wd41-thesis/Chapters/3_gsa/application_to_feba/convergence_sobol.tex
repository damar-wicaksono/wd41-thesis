...
and for each size, the $95\%$ \gls[hyper=false]{ci} length (the difference between the upper bound and lower bound) using the bootstrap technique \cite{Efron1986} using $10'000$ replications.

...
As explained in Chapter 2, two conventional \gls[hyper=false]{qoi} to characterize a reflood curve are the maximum clad temperature and the time of quenching.
...
The \gls[hyper=false]{dffb}-related parameters were next in line with contribution of about $\sim18\%$, while each of the other parameters contributes to less than $10\%$ of the total output variation.
...
Furthermore, other parameters also become more prominent at a later stage of the transient.

...
The \glspl[hyper=false]{qoi} for this screening analysis were the time-averaged quantities for all output types (clad temperature, channel pressure drop and liquid carryover) as explained in Sec.~\ref{sub:sa_application_simulation_experiment}.

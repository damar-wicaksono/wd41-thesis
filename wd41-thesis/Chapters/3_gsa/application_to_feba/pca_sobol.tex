...
\marginpar{Sobol' indices for the 1\textsuperscript{st} \gls[hyper=false]{fpc} of the mid-height clad temperature transient}
...
and confirms the maximum clad temperature as a viable representative \gls[hyper=false]{qoi} during the temperature reversal period.
\bigfigure[pos=tbhp,
...
\marginpar{Sobol' indices for the 2\textsuperscript{nd} \gls[hyper=false]{fpc} of the clad temperature transient}
...
These parameter interactions, associated with a particular mode of variation, could not be captured from the conventional \glspl[hyper=false]{qoi} (e.g., the maximum clad temperature).
...
\marginpar{Sobol' indices for the 1\textsuperscript{st} \gls[hyper=false]{fpc} of the warping function for the clad temperature transient}
for the mid-height clad temperature transient are shown in Fig.~\ref{fig:ch3_plot_sobol_boxplot_tc4_warp_pc1}.

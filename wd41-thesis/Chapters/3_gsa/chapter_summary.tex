...
In Chapter 5, the initial range of variations of the model parameters assumed in this chapter are updated based on available experimental data (i.e., model calibration).

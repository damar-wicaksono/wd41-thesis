...
\marginpar{amplitude vs. phase variation in functional data set}
...
In this work, the notion of variance is used to characterize variation and it is defined relative to the proper mean.

...
\marginpar{the mean of the elementary effects}
\begin{equation}
...
\marginpar{the standard deviation of the elementary effects}
\begin{equation}
...
It is defined as,
\marginpar{the mean of the absolute elementary effects}
\begin{equation}

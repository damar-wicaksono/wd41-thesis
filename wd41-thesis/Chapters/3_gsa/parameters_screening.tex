...
An illustration of a radial design in two-dimensional input parameter space with $4$ base points is shown in Fig.~\ref{fig:ch3_plot_oat_illustration_2}.
...
\begin{figure}[bth]
	\centering
	\includegraphics[scale=0.90]{../figures/chapter3/ipe/importance_classification}

...
\begin{enumerate}
  ...
  Afterward, a variance decomposition method is employed to analyze the contribution of the influential parameters uncertainty on the prediction uncertainty.

...
The main findings and accomplishments of the thesis are summarized through chapter-wise summary starting from Chapter~\ref{ch:gsa} to Chapter~\ref{ch:bayesian_calibration}.
Recommendations of future work are then presented.
Finally, the thesis is concluded by concluding remarks.

% Appendices
Three parts of appendices are included in the back of the thesis.
They include the additional results of the thesis not presented in the main chapters, the computational tools used, and some useful mathematical results and recipes.
Particulars section of these appendices will be referred to in the respective chapters.

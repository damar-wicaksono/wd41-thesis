...
The set of strategies above, namely for sensitivity analysis, for model approximation, and for calibration form a consolidated statistical framework for quantifying the uncertainty in model parameters of a \gls[hyper=false]{th} system code proposed in this thesis.
This section provides a broad overview on the research landscape from the literature on each of the elements of the proposed strategy.

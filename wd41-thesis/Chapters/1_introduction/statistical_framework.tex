...
Bayesian framework for model calibration (or data analysis in general) consists of two main steps:
\emph{It is not finished yet, there would be some additional paragraphs on recent development in NE application}.
% Development in nuclear engineering application

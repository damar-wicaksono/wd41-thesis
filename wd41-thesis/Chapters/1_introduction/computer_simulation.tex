...
a \emph{physics-based} evaluation to demonstrate that a set of \emph{acceptance criteria} are met for all specified postulated transients  
The acceptance criteria, a set of limits and conditions to ensure the integrity of the safety barrier, is set by regulatory bodies.

% Deterministic safety analysis
Such a physics-based evaluation is achieved by the use of scientific codes to predict the response of the plant to a postulated transient scenario.

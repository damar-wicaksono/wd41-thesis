...
The connection between the physics-based evaluation and the de\-monstration of safety are established, among other things, by setting the acceptance criteria in terms limiting physical quantities relevant in  phenomena involved.

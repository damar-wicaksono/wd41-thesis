...
In the end, closure laws in system code are of different origins and they become a major source of uncertainty\footnote{defined in this thesis a state of limited knowledge, that is of \emph{epistemic} nature} in the application of \gls[hyper=false]{th} system codes, especially outside its validation domain.
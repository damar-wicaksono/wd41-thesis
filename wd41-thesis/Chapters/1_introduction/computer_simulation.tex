...
The criteria set by regulatory bodies for all operational states of the plant, normal and off-normal.
...
As noted in \cite{IAEA2009,DAuria2012}, there are four distinct but related disciplines associated with the different physical processes involved that are important in the analysis of the plant:
the neutronics of the core;
the thermo-mechanics of the structure (including the fuel);
the radiological analysis of a possible release;
and, the system thermal-hydraulics of the plant, the subject of the present thesis\footnote{Ref.~\cite{DAuria2012} added one additional key disciplines, namely: reliability analysis. It is excluded in the above listing as it is not technically a discipline of \emph{physics}.}.
Each of these disciplines (or domain) is, in turn, characterized by a distinct set of governing physics of the process involved and thus analyzed by a distinct code.

% Entry to Conservative vs Best Estimate


% From IAEA
%Safety analyses are analytical evaluations of physical phenomena occurring
...
%are met for all postulated initiating events that could occur over a broad range of
...
%Deterministic safety analyses for a nuclear power plant predict the response

...
The following will briefly describe the project and highlight the main lessons learned from the author's perspective through his participation on behalf of the \glsfirst[hyper=false]{psi} \cite{Wicaksono2016a}.
...
The following will describe briefly some of the lessons learned of relevance to the present study.
...
Furthermore, there was a valid issue raised by a participant regarding the possibility of \emph{complicated} code response from simultaneous parameters perturbation \cite{Wicaksono2015}.
...
Finally, there is a natural reluctance in embracing a more advanced method where 
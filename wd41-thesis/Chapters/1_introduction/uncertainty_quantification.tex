...
It is fair to ask whether the calibrated value will hold if the calibration were to be conducted in other \glspl[hyper=false]{setf} for the same phenomena.

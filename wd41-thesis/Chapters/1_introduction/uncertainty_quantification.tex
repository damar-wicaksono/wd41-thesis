...
Finally, there was a natural reluctance in embracing more advanced methods requiring less assumptions (
e.g., normal prior of the parameters, linearity between outputs and parameters, etc.) but with more 

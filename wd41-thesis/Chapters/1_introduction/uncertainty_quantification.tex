...
Some of those specifications (such as the boundary conditions, etc.) are parametrized and constitutes \emph{controllable inputs} denoted by $\bm{x}_c$\footnote{later on, being \emph{controllable} is specifically related to the conditions of a physical experiment which are controlled by the experimentalist.}.

...
The transition (thus the transformation) is carried out at the level of individual walkers.
...
\begin{equation}
	\begin{split}
		 ...
		 & \vec{\bm{\mathcal{Y}}} = [M \mathcal{X}_{l,1} + b, M \mathcal{X}_{l,2} + b, \ldots, M \mathcal{X}_{l, D} + b]
	\end{split}

...
To illustrate the application of the \gls[hyper=false]{mh}, particularly the random walk \gls[hyper=false]{mh}, from generating samples from an arbitrary target distribution,

...
and $z$ is a scalar proposal step size, randomly generated from \cite{Goodman2010,Allison2013},
\begin{equation}
	g(z) \propto z^{-0.5}, \,\,\,\, z \in [a^{-1}, a]
\label{eq:ch5_step_size_distribution}
\end{equation}
where $a$ is a free positive parameter,
and where the value of $2.0$ is widely used as default for many applications \cite{Goodman2010,Hou2012,Foreman-Mackey2013,Akeret2013}.
...
Thirdly and finally,
a proposal step size is randomly generated according to $q$ and a proposed move is made according to Eq. (Fig.~\ref{fig:ch5_aies_stretch_3}).
\bigtriplefigure[pos=tbhp,

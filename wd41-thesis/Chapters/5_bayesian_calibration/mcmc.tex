...
The theorem states that for a given realization $\{\bm{x}^{(i)}\}_{i=1}^I$ of a Markov chain with stationary density $\pi^*$ under certain conditions\footnote{Namely, irreducible, aperiodic, Harris recurrent, \emph{and} geometrically ergodic.}

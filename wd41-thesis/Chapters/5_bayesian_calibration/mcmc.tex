...
% Illustration
To illustrate the difficulty to generate samples from an arbitrate multivariate probability distribution,
...
it will not be the case for an arbitrary high-dimensional \gls[hyper=false]{pdf} (such as a posterior density)\footnote{And in fact, the region around the mode becomes less typical in high-dimension. Moving away from the mode of the density reduce its value while increasing the amount of volume.

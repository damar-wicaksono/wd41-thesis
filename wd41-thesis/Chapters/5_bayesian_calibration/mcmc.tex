...
\marginpar{Metropolis-Hastings algorithm, proposal density and acceptance probability}
...
\end{equation}
If the proposed move is rejected, then the chain remains at its current state for the given iteration.
...
The steps are repeated multiple times until the required length of the chain (i.e., the number of samples) is met.

...
The distribution of the observation error is often assumed as a Gaussian distribution in the applied literature \cite{Wikle1998,Wikle2001,Kennedy2001,Bayarri2007,Arhonditsis2008}
\begin{equation}
...
% Some comments on the assumption of normality
...
a \glsfirst[hyper=false]{gp} can be used to represent a deterministic simulator using an explicit formulation of a stochastic process.

...
Regarding this dichotomy, the present thesis takes a more pragmatic approach: the distinction is rather irrelevant.
...
For instance, experimentalist would have an idea on the extent of the observation error.
Often, these figures can be found on the experiment report.

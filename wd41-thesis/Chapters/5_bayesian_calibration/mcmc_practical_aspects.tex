...
\normdoublefigure[pos=tbhp,
                  ...
                  maincaption={Illustration of autocorrelation functions for three different Markov chains. The Markov chain at the top has the strongest autocorrelation shown as solid line in the right plot. The correlation between samples dies out much longer than the other two chains.},%

...
Because of the strong correlation between \texttt{dffbVIHT} and \texttt{dffbIntDr}, the calibration scheme \texttt{w/ Bias, no dffbVIHT} additional calibration scheme that excludes \texttt{dffbVIHT} was conducted to investigate the effect.
...
However, it is important to note that, in this particular calibration scheme, the range for the \texttt{dffbVIHT} remains at its initial prior range.

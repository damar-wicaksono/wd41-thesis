...
Although the length of the burn-in period can be inferred directly from the plots in Fig.~\ref{fig:ch5_plot_ens_stat_mcmc}, a slightly more precise criteria can be obtained through the autocorrelation time of the running statistics.
...
Additionally, \gls[hyper=false]{mc} simulation for forward uncertainty quantification requires independent samples.

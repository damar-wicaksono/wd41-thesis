...
Finally, it is only for the $CO$ output \gls[hyper=false]{feba} test No. 218, no calibration scheme (not even \texttt{w/o Bias}) gives an improvement on the calibration score.
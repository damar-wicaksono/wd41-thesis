...
The total number of iterations depends on the convergence of the \gls[hyper=false]{mcmc} simulation (discarding the initialization biase) and the required level statistical error as detailed in Section~\ref{sec:bc_mcmc_diagnostic}.

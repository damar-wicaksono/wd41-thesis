...
In the \gls[hyper=false]{feba} experiment, this type of uncertainty was not directly observed as there was no replication of the experiment at the same controllable inputs and the experimental uncertainty with respect to each type of data was taken as given from the benchmark specification.

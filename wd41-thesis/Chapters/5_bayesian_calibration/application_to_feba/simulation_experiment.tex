...
Each calibration scheme, the \gls[hyper=false]{mcmc} sampler, and a method to evaluate and compare different posterior prediction uncertainties will be detailed further below. 

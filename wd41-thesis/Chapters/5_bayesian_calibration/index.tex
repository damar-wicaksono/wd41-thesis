...
=======
% Link paragraph
In Chapter 3, a sensitivity analysis method was employed to understand better the inputs/outputs relationship in a computer simulation model where its inputs were considered uncertain.
...
The respective methods were exemplified by their application to a \gls[hyper=false]{trace} reflood simulation model whose inputs were uncertain, as assumed in Chapter~2.
...
The posterior density is often a highly multi-dimensional function.
As a probability density, it involves normalizing factor that requires a multi-dimensional integration across the input parameter space.

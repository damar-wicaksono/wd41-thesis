...
According to Section~\ref{sub:intro_objectives} the listed objectives of the proposed methods were:
\begin{itemize}
	\item GSA
	\item Metamodel
	\item Calibration
...
%---------------------------------------------------------
\subsection{Implementation and Application of GSA Methods}
%---------------------------------------------------------
...
%-----------------------------------------------------------
\subsection{Development and Validation of a TRACE Metamodel}
%-----------------------------------------------------------
...
%-----------------------------------------------------------------
\subsection{Bayesian Calbration of TRACE Reflood Model Parameters}
%-----------------------------------------------------------------

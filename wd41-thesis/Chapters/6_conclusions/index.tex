...
To that end, a methodology has been developed -- and its application demonstrated -- to quantify the uncertainty of physical model parameters important in the simulation of a reflood experiment;
...
a set of sensitivity analysis methods were then applied to assess the importance of each selected input parameters and to select model parameters that were truly important for the reflood simulation.

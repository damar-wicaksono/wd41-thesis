# Create corner plot for the 7-parameter model
plot_ensemble7 <- function(ens_rds, burnin, param_names, param_ranges,
                           n_bins = 100)
{
    ...
    for (i in 1:7)
    {
        for (j in 1:7)
        {
            if (i == j)
            {
                ...
                p[[k]] <- p[[k]] + geom_vline(
                    xintercept = quantile(ens_samples_rescaled[,i], probs = c(0.025, 0.975)))
    ...
    multiplot(p[[1]], p[[8]],  p[[15]], p[[22]], p[[29]], p[[36]], p[[43]],
              p[[2]], p[[9]],  p[[16]], p[[23]], p[[30]], p[[37]], p[[44]],
              p[[3]], p[[10]], p[[17]], p[[24]], p[[31]], p[[38]], p[[45]],
              p[[4]], p[[11]], p[[18]], p[[25]], p[[32]], p[[39]], p[[46]],
              p[[5]], p[[12]], p[[19]], p[[26]], p[[33]], p[[40]], p[[47]],
              p[[6]], p[[13]], p[[20]], p[[27]], p[[34]], p[[41]], p[[48]],
              p[[7]], p[[14]], p[[21]], p[[28]], p[[35]], p[[42]], p[[49]],
              cols = 7)

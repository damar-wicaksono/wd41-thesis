...
# Global variables ------------------------------------------------------------
# Output filename
otpfullname <- "./figures/plotEnsDPDiscCentered.png"
...
#ens_rds_fullname <- "F:\\wd41-thesis\\trace-mcmc\\trace-mcmc-fixvar-revise-reduced\\results\\2000\\216-ens-dp-1000-2000-fix_bc-fix_scale-unbiased-nobc.Rds"

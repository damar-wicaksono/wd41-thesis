...
set.seed(23904)
# Output filename
otpfullnames <- c("./figures/plotInfluentialNonInfluentialRunsTC.png",
                  "./figures/plotInfluentialNonInfluentialRunsDP.png",
                  "./figures/plotInfluentialNonInfluentialRunsCO.png")

# Input filenames
# TC and CO
trc_runs_influential_fullname <- "../../../../wd41-thesis/postpro/result-compiled/febaTrans216-febaVars12Influential-lhs_1000_12.Rds"
trc_runs_noninfluential_fullname <- "../../../../wd41-thesis/postpro/result-compiled/febaTrans216-febaVars15NonInfluential-lhs_1000_15.Rds"
# Smoothed Pressure Drop
trc_runs_influential_dp_fullname <- "../../../../wd41-thesis/postpro/result-compiled/febaTrans216-febaVars12Influential-lhs_1000_12-dp_mid-fd.Rds"
trc_runs_noninfluential_dp_fullname <- "../../../../wd41-thesis/postpro/result-compiled/febaTrans216-febaVars15NonInfluential-lhs_1000_15-dp_mid-fd.Rds"
...
output_names <-  c("TC4",
                   "Mid DP (1.7 - 2.3 [m])",
                   "Liquid Carryover")
levels(trc_runs_df$output) <- output_names

# Make plot -------------------------------------------------------------------
for (i in 1:3)
{
    p <- ggplot(data = subset(trc_runs_df, output == output_names[i]), 

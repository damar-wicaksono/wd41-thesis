...
otpfullnames <- c("./figures/plotExplainedVarianceTC4.pdf",
                  ...
                  "./figures/plotExplainedVarianceCO.pdf") # Output filenames

pca_fd_fullnames <- c("../../../analysis/sobol/results/tc_regfd_pcafd-tc_4.Rds",
...
for (i in 1:3)
{
    ...
    # Make the plot
    p <- ggplot(pca_10_varprop) + geom_bar(aes(x=pca, y=varprop, group=1), 
                                           fill = "gray15",
                                           stat="identity")

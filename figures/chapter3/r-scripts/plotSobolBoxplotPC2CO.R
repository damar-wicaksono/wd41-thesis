...
bootstrap_files <- c(
    ...
    "../../../analysis/sobol/results/bootstrap-sti-co-pc2-2000.csv")
indices_file <- c(
    "../../../analysis/sobol/results/estimate-co-pc2-2000.csv")
...
sum(indices_df[, idx_estimator]) # 0.96

# Make a title informing the sum of the first order indices
first_line <- "Sum of the main effect indices = 0.96"

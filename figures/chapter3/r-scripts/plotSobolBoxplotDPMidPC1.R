#
# title     : plotSobolBoxplotPC1DPMid.R
# purpose   : Script to create a boxplot of Sobol Indices for each parameter
#           : with PC1 of middle pressure drop as the QoI
...
# Input filenames
bootstrap_files <- c(
    "../../../analysis/sobol/results/bootstrap-saltelli-dp_mid-pc1-2000.csv",
    "../../../analysis/sobol/results/bootstrap-sti-dp_mid-pc1-2000.csv")
indices_file <- c(
    "../../../analysis/sobol/results/estimate-dp_mid-pc1-2000.csv")
...
sum(indices_df[, idx_estimator]) # 0.88

# Make a title informing the sum of the first order indices
first_line <- "Sum of the main effect indices = 0.88"

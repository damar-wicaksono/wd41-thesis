#
# title     : plotPCGPConstructionDP.R
# purpose   : R script to create a facet plot of the sensitivity of
#           : reconstruction RMSE for the pressure drop output to the different
#           : options in the construction of Gaussian process metamodel
...
p <- p + scale_y_continuous(limits = c(75, 200))

#
# title     : plotPCGPConstructionCO.R
# purpose   : R script to create a facet plot of the sensitivity of
#           : reconstruction RMSE for the liquid carryover output to the
#           : different options in the construction of Gaussian process 
#           : metamodel
...
# Global variables ------------------------------------------------------------
# Output filename
otpfullname <- "./figures/plotPCGPConstructionCO.pdf"
...
error_type <- "recPC5_RMSE"

# Graphic variables
fig_size <- c(18, 9)             # width, height
y_lab <- "PC Reconstruction Error [kg]"

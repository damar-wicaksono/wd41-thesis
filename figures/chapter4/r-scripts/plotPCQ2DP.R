...
#           : metamodel of the pressure drop output based on the Q2 metric
...
# Global variables ------------------------------------------------------------
# Output filename
otpfullname <- "./figures/plotPCQ2DP.pdf"
...
idx_pc <- c(1, 5, 10)    # Selected PC to present
...
# Pre-process Data ------------------------------------------------------------
exp_var <- round((pc_df$yy_train_var/sum(pc_df$yy_train_var))[idx_pc] * 100, 1)

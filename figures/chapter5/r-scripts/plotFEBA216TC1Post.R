...
# Output filename
otpfullnames <- c("./figures/plotFEBA216TC1Post_1.pdf",
                  "./figures/plotFEBA216TC1Post_2.pdf",
                  "./figures/plotFEBA216TC1Post_3.pdf")
...
# Make the plot
p1 <- plotSingleTC(rds_tidy_prior_fullname,
...
# Make the plot
p2 <- plotSingleTC(rds_tidy_prior_fullname,
                   rds_tidy_corr_fullname,
                   rds_tidy_ind_fullname)
...
# Make the plot
p3 <- plotSingleTC(rds_tidy_prior_fullname,
                   rds_tidy_corr_fullname,
                   rds_tidy_ind_fullname)

...
calibinfo_df1$case_name <- revalue(calibinfo_df1$case_name,
                                   c("mcmcAllDiscCentered" = "w/ Bias, All, Corr.",
                                     ...
                                     "mcmcAllDiscCenteredNoParam8" = "w/ Bias term, no dffbVIHT, Corr.",
                                     "mcmcAllDiscCenteredNoParam8Ind" = "w/ Bias term, no dffbVIHT, Ind.",
...
calibinfo_df1$case_name <- factor(calibinfo_df1$case_name,
                                     levels = c("w/ Bias, All, Corr.",
                                                "w/ Bias, All, Ind.",
                                                "w/ Bias term, no dffbVIHT, Corr.",
                                                "w/ Bias term, no dffbVIHT, Ind.",
                                                "w/o Bias, Corr.",
                                                "w/o Bias, Ind.",
                                                "w/ Bias, TC",
                                                "w/ Bias, DP",

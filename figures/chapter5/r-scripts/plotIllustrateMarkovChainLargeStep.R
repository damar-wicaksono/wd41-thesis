...
# Global variables ------------------------------------------------------------
set.seed(23450)
otpfullnames <- c("./figures/plotIllustrateMarkovChainLargeStep_1.pdf",
                  "./figures/plotIllustrateMarkovChainLargeStep_2.pdf")
...
scl <- 100 # Very small step
mcmc <- mcmc_sample(n_samples, c(-1.0, -10.0), scl^2 * corr_matrix_prop)

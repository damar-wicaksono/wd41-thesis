...
# Add plot title
plot_title <- parse(
  text = "'FEBA Test No. 216, '*P[sys]*' = 4.1 [bar], Flooding Rate = 3.8 ['*m.s^-1*'], Calibration scheme w/ Bias, All'")
# Make the plot
...
plot_title <- parse(
  text = "'FEBA Test No. 216, '*P[sys]*' = 4.1 [bar], Flooding Rate = 3.8 ['*m.s^-1*'], Calibration scheme w/o Bias'")
# Make the plot
source("./r-scripts/plotTraceUQPosteriorDP.R")
...
# Add plot title
plot_title <- parse(
  text = "'FEBA Test No. 216, '*P[sys]*' = 4.1 [bar], Flooding Rate = 3.8 ['*m.s^-1*'], Calibration scheme w/ Bias, no dffbVIHT'")
# Make the plot
source("./r-scripts/plotTraceUQPosteriorDP.R")

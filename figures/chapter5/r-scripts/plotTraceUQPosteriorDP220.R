#
# title     : plotTraceUQPosteriorDP220.R
...
# Add plot title
plot_title <- parse(
  text = "'FEBA Test No. 220, '*P[sys]*' = 6.2 [bar], Flooding Rate = 3.9 ['*m.s^-1*'], Calibration scheme w/ Bias, All'")
# Make the plot
...
plot_title <- parse(
  text = "'FEBA Test No. 220, '*P[sys]*' = 6.2 [bar], Flooding Rate = 3.9 ['*m.s^-1*'], Calibration scheme w/o Bias'")
# Make the plot
source("./r-scripts/plotTraceUQPosteriorDP.R")
...
# Add plot title
plot_title <- parse(
  text = "'FEBA Test No. 220, '*P[sys]*' = 6.2 [bar], Flooding Rate = 3.9 ['*m.s^-1*'], Calibration scheme w/ Bias, no dffbVIHT'")
# Make the plot
source("./r-scripts/plotTraceUQPosteriorDP.R")

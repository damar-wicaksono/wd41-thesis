#
# title     : plotTraceUQPosteriorAllDiscCenteredDP.R
...
# Global variables ------------------------------------------------------------
# Output filename
otpfullname <- "./figures/plotTraceUQPosteriorAllDiscCenteredDP.pdf"

# Input filename
rds_tidy_prior_fullname <- "../data-support/postpro/srs/febaTrans216-febaVars12Influential-srs_1000_12-dp-tidy.Rds"
rds_tidy_corr_fullname <- "../data-support/postpro/disc/centered/all-params/correlated/febaTrans216-febaVars12Influential-mcmcAllDiscCentered_1000_12-dp-tidy.RDs"
rds_tidy_ind_fullname <- "../data-support/postpro/disc/centered/all-params/independent/febaTrans216-febaVars12Influential-mcmcAllDiscCenteredInd_1000_12-dp-tidy.RDs"
